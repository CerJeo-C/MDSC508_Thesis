...
data_dir="/home/sergiu.cociuba/BoneLab/DAFT/daft/Data03/Radius/Test"                        # Where the test directory is
file="TestResNet.py"                                                             # Which python script you want to run
bone="r"
model="/home/sergiu.cociuba/BoneLab/DAFT/daft/Results/NewResults/Radius/ResNet_train/Best_Model_Fold_4_Epoch_17.pth"
